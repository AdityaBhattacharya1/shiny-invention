...
#         with self.assertRaises(ValueError) as context:
#             self.handler.get_option_chain_data("NIFTY", "2024-10-01", "CE")
...
#         with self.assertRaises(ValueError) as context:
#             self.handler.get_option_chain_data("NIFTY", "2024-10-31", "INVALID_SIDE")
#         self.assertEqual(
...
#         with self.assertRaises(ValueError) as context:
#             self.handler.get_option_chain_data("NIFTY", "2023-10-01", "CE")
#         self.assertIn("cannot be found", str(context.exception))
